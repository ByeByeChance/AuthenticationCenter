...
export const DATA_MANAGEMENT_URL = import.meta.env.VITE_DATA_MANAGEMENT_URL || "http://10.168.1.155:81/#/portalSoftLanding";
...
export const ALGORITHM_MANAGEMENT_URL =
  import.meta.env.VITE_ALGORITHM_MANAGEMENT_URL || "http://10.168.1.71:30515/#/portalSoftLanding";
...
export const AIGC_ALGORITHM_VERIFICATION_URL =
  import.meta.env.VITE_AIGC_ALGORITHM_VERIFICATION_URL || "http://10.168.1.67:8849/#/portalSoftLanding";
